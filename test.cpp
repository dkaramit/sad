...
int main(){
    ...
    std::map at=sad::at(std::vector{x,y},std::vector{0.,3.}) ;
    ...
    // cout<<evaluate(derivative(z,x,x), at )<<"\n";
    cout<<evaluate(derivative(z,x,x,x), at )<<"\n";
    // cout<<evaluate(derivative(z,x,x,x,x), at )<<"\n";
